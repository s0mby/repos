...
private:
    float bono;
public:
    Gerente(string nombre, float salario, int anio, int mes, int dia, float bono) : Empleado(nombre, salario, anio, mes, dia) {
        this->bono = bono;
    }
...
private:
    ...
    float pagoHoraExtra;
public:
    Desarrollador(string nombre, float salario, int anio, int mes, int dia, int horasExtra, float pagoHoraExtra) : Empleado(nombre, salario, anio, mes, dia) {
        this->horasExtra = horasExtra;
        this->pagoHoraExtra = pagoHoraExtra;
    }
    float calcularSalario() override {
...
private:
    float comisionProyectos;
public:
    Diseñador(string nombre, float salario, int anio, int mes, int dia, float comisionProyectos) : Empleado(nombre, salario, anio, mes, dia) {
        this->comisionProyectos = comisionProyectos;
    }
    float calcularSalario() override {
...
int main() {
    // Creando empleados de diferentes tipos
    Gerente PedroPaz("Pedro Paz", 2500, 2022, 3, 1, 400);
    Gerente LiamSol("Liam Sol", 2800, 2021, 7, 15, 400);
    Desarrollador MariaVelez("Maria Velez", 2000, 2023, 5, 10, 10, 35);
    Diseñador SimeoVill("Simeo Vill", 1800, 2024, 2, 15, 200);
